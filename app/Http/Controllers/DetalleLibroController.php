...
class DetalleLibroController extends Controller
{
     ...
     */
    public function modal_registro(Request $request)
    {
        $user = auth()->id();
        $sp = DB::table('sujeto_pasivos')->select('id_sujeto')->where('id_user','=',$user)->first();
        $id_sp = $sp->id_sujeto;
                            ...
                            <div class="row px-3 d-flex align-items-center">
                                ...
                                <div class="col-sm-3">
                                    <div class="row g-3 align-items-center mb-2">
                                        ...
                                        <div class="col-8">
                                            <input type="date" id="fecha_facturacion" class="form-control form-control-sm" name="fecha_facturacion"  min="'.$min.'" max="'.$max.'" value="'.$guia->fecha_facturacion.'" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
